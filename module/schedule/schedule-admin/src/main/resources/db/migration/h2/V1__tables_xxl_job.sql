...
CREATE TABLE `XXL_JOB_QRTZ_TRIGGER_INFO` (
  ...
  `glue_switch` BIGINT DEFAULT '0' COMMENT 'GLUE模式开关：0-否，1-是',
...
CREATE TABLE `XXL_JOB_QRTZ_TRIGGER_LOG` (
  ...
  `trigger_code` BIGINT DEFAULT NULL COMMENT '调度-结果',
  `trigger_msg` varchar(2048) DEFAULT NULL COMMENT '调度-日志',
  `handle_time` datetime DEFAULT NULL COMMENT '执行-时间',
  `handle_code` BIGINT DEFAULT NULL COMMENT '执行-状态',
...
CREATE TABLE `XXL_JOB_QRTZ_TRIGGER_GROUP` (
  ...
  `order1` BIGINT NOT NULL DEFAULT '0' COMMENT '排序',
  `address_type` BIGINT NOT NULL DEFAULT '0' COMMENT '执行器地址类型：0=自动注册、1=手动录入',
...
INSERT INTO `XXL_JOB_QRTZ_TRIGGER_GROUP` ( `app_name`, `title`, `order1`, `address_type`, `address_list`) values ( 'xxl-job-executor-example', '示例执行器', '1', '0', null);
